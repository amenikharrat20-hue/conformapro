...
DROP POLICY IF EXISTS "Authenticated users can view domaines" ON public.domaines_application;
DROP POLICY IF EXISTS "Admin global can manage domaines" ON public.domaines_application;
DROP POLICY IF EXISTS "Authenticated users can view sous-domaines" ON public.sous_domaines_application;
DROP POLICY IF EXISTS "Admin global can manage sous-domaines" ON public.sous_domaines_application;
DROP POLICY IF EXISTS "Authenticated users can view textes_domaines" ON public.textes_domaines;
DROP POLICY IF EXISTS "Admin global can manage textes_domaines" ON public.textes_domaines;
DROP POLICY IF EXISTS "Authenticated users can view textes_sous_domaines" ON public.textes_sous_domaines;
DROP POLICY IF EXISTS "Admin global can manage textes_sous_domaines" ON public.textes_sous_domaines;
DROP POLICY IF EXISTS "Authenticated users can view articles_versions" ON public.articles_versions;
DROP POLICY IF EXISTS "Admin global can manage articles_versions" ON public.articles_versions;
DROP POLICY IF EXISTS "Authenticated users can view articles_sous_domaines" ON public.articles_sous_domaines;
DROP POLICY IF EXISTS "Admin global can manage articles_sous_domaines" ON public.articles_sous_domaines;
